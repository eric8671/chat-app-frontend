  ...
  const {selectedChat,setSelectedChat, user}=ChatState();
    ...
    const handleRemove=async(user1)=>{
      ...
      try {
        ...
        const {data} = await axios.put(
          `https://shashikant-connectify-api5.onrender.com/api/chat/groupremove`,{
    ...
    const handleAddUser=async(user1)=>{
        ...
        try {
          ...
          const {data}= await axios.put(`https://shashikant-connectify-api5.onrender.com/api/chat/groupadd`,{
            chatId: selectedChat._id,
            userId: user1._id,
          },config);
    ...
    const handleRename=async()=>{
      ...
      try {
        ...
        const {data} = await axios.put(`https://shashikant-connectify-api5.onrender.com/api/chat/rename`,{
          chatId: selectedChat._id,
